...
# ----- Wikipedia API Initialization (DJPSY TEAM) -----
import time
import sys
...
# ----- OpenWeatherMap API Initialization (DJPSY TEAM) -----
owm = OWM('YOUR_OWM_API_KEY')

# ----- ipstack Geolocation API Initialization (DJPSY TEAM) -----
...
# ----- Figuring out how users might respond (DJPSY TEAM) -----
answer_A = ["A", "a", "A.", "a."]
answer_B = ["B", "b", "B.", "b."]
answer_C = ["C", "c", "C.", "c."]
yes = ["Y", "y", "Yes", "yes", "YES"]
...
# -- Return to Main Menu (DJPSY TEAM) --
...
# ----- Retrieve Summary of Wikipedia Article (DJPSY TEAM) -----
def wiki_article_validate(articlename):
    ...
    if page_py.exists() == True:
        ...
        )  # This line was done with assistance
        print(
...
# ----- Definitions for Interactive Story -----
